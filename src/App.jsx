...
import logoSuplaBoard from "../pages/img/SuplaBoard.png";
...
function extrairTurma(row) {
  ...
  const segmentoInfo = pegarCampoComChave(row, [
    "segmento",
    "nivel",
    "etapa",
    "ensino",
  ...
  const turnoInfo = pegarCampoComChave(row, [
    "turno",
    "periodo",
  ]);
  ...
  if (
    mediaInfo &&
    frequenciaInfo &&
    mediaInfo.chave === frequenciaInfo.chave
  ) {
    mediaInfo = null;
  }
  ...
  if (!mediaInfo) {
    mediaInfo = pegarNumericoRestante(
      row,
      chavesJaUsadas
    );
  }
  ...
  const totalAlunos = pegarTotalAlunos(
    row,
    chavesJaUsadas
  );
  ...
  return {
    ...
    frequencia:
      formatarPercentual(frequenciaBruta),

    media:
      formatarMedia(mediaBruta),
...
function criarRanking(turmas) {
  ...
  return turmas
    ...
    .map((turma) => {
      const valores = [
        turma.frequenciaNormalizada,
        turma.mediaNormalizada,
      ].filter(
        (valor) =>
          valor !== null &&
          valor !== undefined
...
function calcularResumo(turmas) {
  ...
  const averagePresence =
    frequenciasValidas.length
      ? frequenciasValidas.reduce(
          (soma, valor) =>
            soma + valor,
          0
        ) /
      ...
      <aside className="sidebar">
        ...
        <div className="ranking-sidebar-card">
          ...
          <div className="ranking-sidebar-header">
            ...
            <p className="ranking-sidebar-eyebrow">
              Top 5
            </p>
          ...
          <div className="ranking-sidebar-list">
            ...
            {topoRanking.map(
              (turma) => (
                ...
                <div
                  key={turma.id}
                  className="ranking-sidebar-item"
                >

                  <div
                    className={`ranking-sidebar-badge ${turma.badgeClass}`}
                  >
                    {turma.rank}º
                  </div>
                  ...
                  <div className="ranking-sidebar-content">
                    ...
                    <span className="ranking-sidebar-turma">
                      {turma.nome}
                    </span>
        ...
        <div className="sidebar-clock-card">
          ...
          <span className="sidebar-clock-label">
            Horário
          </span>
          ...
          <span className="sidebar-clock-date">
            {data}
          </span>
